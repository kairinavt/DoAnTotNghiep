      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _buildTypeChip('Phòng', Icons.home),
                const SizedBox(width: 8),
                _buildTypeChip('Lầu', Icons.business),
                const SizedBox(width: 8),
                ...
                child: ElevatedButton(
                  onPressed: _searchController.text.trim().isEmpty
                      ...
                      : () {
                          ...
                          String fullResult =
                              '[$_addressType] ${_searchController.text}';
  ...
  Widget _buildTypeChip(String label, IconData icon) {
    ...
    return ChoiceChip(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
            color: isSelected ? const Color(0xfff56789) : Colors.transparent),
      ),
      onSelected: (selected) {
