        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text('Của bạn', style: TextStyle(color: kTextGrey, fontSize: 12)),
                const Text('Món đã thích ❤️',
                    style: TextStyle(color: kTextDark, fontSize: 18, fontWeight: FontWeight.w800)),
              ],
            ),
          ),
              ...
              child: Container(
                ...
                child: Row(children: [
                  Icon(Icons.sort_rounded,
                      size: 15, color: _sortOption.isNotEmpty ? kPink : kTextGrey),
  ...
  Widget _buildGrid() {
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 2, childAspectRatio: 155 / 230,
    ...
    return Center(child: Column(
      ...
      children: [
        ...
        const Text('Chưa có món nào được yêu thích',
            style: TextStyle(color: kTextGrey, fontSize: 15, fontWeight: FontWeight.w500)),
